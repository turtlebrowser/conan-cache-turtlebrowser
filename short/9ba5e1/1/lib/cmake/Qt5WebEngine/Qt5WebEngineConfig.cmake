...
set(Qt5WebEngine_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::WebEngine)
    ...
    set(Qt5WebEngine_PRIVATE_INCLUDE_DIRS
        "${_qt5WebEngine_install_prefix}/include/QtWebEngine/5.15.0"
        "${_qt5WebEngine_install_prefix}/include/QtWebEngine/5.15.0/QtWebEngine"
    )
    ...
    foreach(_module_dep ${_Qt5WebEngine_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5WebEngine_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::WebEngine)
    ...
    _populate_WebEngine_target_properties(RELEASE "Qt5WebEngine.dll" "Qt5WebEngine.lib" FALSE)

    if (EXISTS
        "${_qt5WebEngine_install_prefix}/bin/Qt5WebEngined.dll"
      AND EXISTS
        "${_qt5WebEngine_install_prefix}/lib/Qt5WebEngined.lib" )
        _populate_WebEngine_target_properties(DEBUG "Qt5WebEngined.dll" "Qt5WebEngined.lib" FALSE)
    endif()
