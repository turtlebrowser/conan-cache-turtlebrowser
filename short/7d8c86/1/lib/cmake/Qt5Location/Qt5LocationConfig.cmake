...
if (NOT TARGET Qt5::Location)
    ...
    _populate_Location_target_properties(RELEASE "Qt5Location.dll" "Qt5Location.lib" FALSE)

    if (EXISTS
        "${_qt5Location_install_prefix}/bin/Qt5Locationd.dll"
      AND EXISTS
        "${_qt5Location_install_prefix}/lib/Qt5Locationd.lib" )
        _populate_Location_target_properties(DEBUG "Qt5Locationd.dll" "Qt5Locationd.lib" FALSE)
    endif()
