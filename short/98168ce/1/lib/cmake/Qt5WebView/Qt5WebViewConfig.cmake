...
if (NOT TARGET Qt5::WebView)
    ...
    _populate_WebView_target_properties(RELEASE "Qt5WebView.dll" "Qt5WebView.lib" FALSE)

    if (EXISTS
        "${_qt5WebView_install_prefix}/bin/Qt5WebViewd.dll"
      AND EXISTS
        "${_qt5WebView_install_prefix}/lib/Qt5WebViewd.lib" )
        _populate_WebView_target_properties(DEBUG "Qt5WebViewd.dll" "Qt5WebViewd.lib" FALSE)
    endif()
