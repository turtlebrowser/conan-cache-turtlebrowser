...
if (NOT TARGET Qt5::Positioning)
    ...
    _populate_Positioning_target_properties(RELEASE "Qt5Positioning.dll" "Qt5Positioning.lib" FALSE)

    if (EXISTS
        "${_qt5Positioning_install_prefix}/bin/Qt5Positioningd.dll"
      AND EXISTS
        "${_qt5Positioning_install_prefix}/lib/Qt5Positioningd.lib" )
        _populate_Positioning_target_properties(DEBUG "Qt5Positioningd.dll" "Qt5Positioningd.lib" FALSE)
    endif()
