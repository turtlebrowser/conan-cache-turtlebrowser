...
set(Qt5WebEngineCore_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::WebEngineCore)
    ...
    set(Qt5WebEngineCore_PRIVATE_INCLUDE_DIRS
        "${_qt5WebEngineCore_install_prefix}/include/QtWebEngineCore/5.15.0"
        "${_qt5WebEngineCore_install_prefix}/include/QtWebEngineCore/5.15.0/QtWebEngineCore"
    )
    ...
    foreach(_module_dep ${_Qt5WebEngineCore_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5WebEngineCore_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::WebEngineCore)
    ...
    set_property(TARGET Qt5::WebEngineCore
                 ...
                 webengine-alsa;webengine-arm-thumb;webengine-embedded-build;webengine-noexecstack;webengine-ozone-x11;webengine-poppler-cpp;webengine-proprietary-codecs;webengine-pulseaudio;webengine-sanitizer)
    ...
    _populate_WebEngineCore_target_properties(RELEASE "Qt5WebEngineCore.dll" "Qt5WebEngineCore.lib" FALSE)

    if (EXISTS
        "${_qt5WebEngineCore_install_prefix}/bin/Qt5WebEngineCored.dll"
      AND EXISTS
        "${_qt5WebEngineCore_install_prefix}/lib/Qt5WebEngineCored.lib" )
        _populate_WebEngineCore_target_properties(DEBUG "Qt5WebEngineCored.dll" "Qt5WebEngineCored.lib" FALSE)
    endif()
