...
set(Qt5Pdf_VERSION_STRING 5.15.2)
...
macro(_populate_Pdf_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set_target_properties(Qt5::Pdf PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt5Pdf.so.5"
...
if (NOT TARGET Qt5::Pdf)
    ...
    set(Qt5Pdf_PRIVATE_INCLUDE_DIRS
        "${_qt5Pdf_install_prefix}/include/QtPdf/5.15.2"
        "${_qt5Pdf_install_prefix}/include/QtPdf/5.15.2/QtPdf"
    )
    ...
    foreach(_module_dep ${_Qt5Pdf_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5Pdf_FIND_VERSION_EXACT}
    ...
    _populate_Pdf_target_properties(RELEASE "libQt5Pdf.so.5.15.2" "" FALSE)
