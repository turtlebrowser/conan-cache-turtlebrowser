...
set(Qt5PdfWidgets_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::PdfWidgets)
    ...
    set(Qt5PdfWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5PdfWidgets_install_prefix}/include/QtPdfWidgets/5.15.2"
        "${_qt5PdfWidgets_install_prefix}/include/QtPdfWidgets/5.15.2/QtPdfWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5PdfWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5PdfWidgets_FIND_VERSION_EXACT}
    ...
    _populate_PdfWidgets_target_properties(DEBUG "libQt5PdfWidgets_debug.5.15.2.dylib" "" FALSE)
